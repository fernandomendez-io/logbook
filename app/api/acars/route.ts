  ...
  await supabase.from("acars_cache").upsert(
    {
      ...
      origin_timezone:      mergedTimes.originTimezone      ?? null,
      dest_timezone:        mergedTimes.destTimezone        ?? null,
      origin_icao_fa:       mergedTimes.originIcao          ?? null,
      dest_icao_fa:         mergedTimes.destIcao            ?? null,
      route:                mergedTimes.route               ?? null,
      route_distance_nm:    mergedTimes.routeDistanceNm     ?? null,
      filed_airspeed_kts:   mergedTimes.filedAirspeedKts    ?? null,
      filed_altitude_ft:    mergedTimes.filedAltitudeFt     ?? null,
      terminal_origin:      mergedTimes.terminalOrigin      ?? null,
      terminal_destination: mergedTimes.terminalDestination ?? null,
      baggage_claim:        mergedTimes.baggageClaim        ?? null,
    },
