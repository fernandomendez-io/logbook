...
export const CARRIERS: Carrier[] = [
  ...
  {
    value: "MQ_AA",
    label: "American Eagle – Envoy Air (MQ)",
    iata: "MQ",
    displayPrefix: "MQ",
    searchPrefix: "AA",
    mainline: "AA",
  ...
  {
    value: "YV_AA",
    label: "American Eagle – Mesa Air (YV)",
    iata: "YV",
    displayPrefix: "YV",
    searchPrefix: "AA",
    mainline: "AA",
  ...
  {
    value: "OO_AA",
    label: "American Eagle – SkyWest (OO/AA)",
    iata: "OO",
    displayPrefix: "OO",
    searchPrefix: "AA",
    mainline: "AA",
  ...
  {
    value: "PT_AA",
    label: "American Eagle – Piedmont Airlines (PT)",
    iata: "PT",
    displayPrefix: "PT",
    searchPrefix: "AA",
    mainline: "AA",
  ...
  {
    value: "OH_AA",
    label: "American Eagle – PSA Airlines (OH)",
    iata: "OH",
    displayPrefix: "OH",
    searchPrefix: "AA",
    mainline: "AA",
  ...
  {
    value: "OO_UA",
    label: "United Express – SkyWest (OO/UA)",
    iata: "OO",
    displayPrefix: "OO",
    searchPrefix: "UA",
    mainline: "UA",
  ...
  {
    value: "G7_UA",
    label: "United Express – GoJet Airlines (G7)",
    iata: "G7",
    displayPrefix: "G7",
    searchPrefix: "UA",
    mainline: "UA",
  ...
  {
    value: "ZW_UA",
    label: "United Express – Air Wisconsin (ZW)",
    iata: "ZW",
    displayPrefix: "ZW",
    searchPrefix: "UA",
    mainline: "UA",
  ...
  {
    value: "YV_UA",
    label: "United Express – Mesa Air (YV/UA)",
    iata: "YV",
    displayPrefix: "YV",
    searchPrefix: "UA",
    mainline: "UA",
  ...
  {
    value: "C5_UA",
    label: "United Express – CommutAir (C5)",
    iata: "C5",
    displayPrefix: "C5",
    searchPrefix: "UA",
    mainline: "UA",
  ...
  {
    value: "9E_DL",
    label: "Delta Connection – Endeavor Air (9E)",
    iata: "9E",
    displayPrefix: "9E",
    searchPrefix: "DL",
    mainline: "DL",
  ...
  {
    value: "OO_DL",
    label: "Delta Connection – SkyWest (OO/DL)",
    iata: "OO",
    displayPrefix: "OO",
    searchPrefix: "DL",
    mainline: "DL",
  ...
  {
    value: "YX_DL",
    label: "Delta Connection – Republic Airways (YX)",
    iata: "YX",
    displayPrefix: "YX",
    searchPrefix: "DL",
    mainline: "DL",
...
export function getDisplayPrefix(
  ...
  return (
    CARRIERS.find((c) => c.value === operatingCarrier)?.displayPrefix ?? null
  );
}
...
export function getSearchPrefix(
  ...
  if (!operatingCarrier) return null;
  return (
    CARRIERS.find((c) => c.value === operatingCarrier)?.searchPrefix ?? null
  );
}

/** @deprecated use getDisplayPrefix */
export function getFlightPrefix(
  operatingCarrier?: string | null,
): string | null {
...
export function prefixFlightForSearch(
  ...
  const prefix = getSearchPrefix(operatingCarrier);
  if (!prefix) return flightNumber;
